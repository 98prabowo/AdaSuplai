...
class BuyNowController: BaseUIViewController, UIGestureRecognizerDelegate {
    private enum Constant {
        static let header = "Beli Langsung"
    ...
    private func setupTableView() {
        ...
        self.tableView.registerNib(forCell: QuantityCell.self)
...
extension BuyNowController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        default:
            ...
            return self.viewModel.getProductCountPerSection(with: supplierID) + 3
        }
    }
...
extension BuyNowController {
    ...
    private func getBodyCell(for indexPath: IndexPath) -> UITableViewCell {
        ...
        case products.count + 1:
            let cell = tableView.dequeueReusableCell(withCell: QuantityCell.self, for: indexPath)
            cell.delegate = self
            cell.separatorInset = UIEdgeInsets(top: 0, left: tableView.bounds.size.width, bottom: 0, right: 0)
            return cell
        case products.count + 2:
...
// MARK: Delegate
extension BuyNowController: TransactionCellDelegate {
